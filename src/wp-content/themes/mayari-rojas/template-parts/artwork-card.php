...
<?php if ( gmr_theme_can_view_price( get_the_ID() ) ) : ?><div class="gmr-card__price"><?php echo $product && $product->get_price() ? wp_kses_post( $product->get_price_html() ) : esc_html( get_post_meta( get_the_ID(), 'gmr_price_label', true ) ?: 'Consultar' ); ?></div><?php endif; ?>
</a></article>
