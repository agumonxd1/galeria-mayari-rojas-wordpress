...
<a class="gmr-account" href="<?php echo esc_url( is_user_logged_in() ? gmr_theme_page_url( 'coleccionistas' ) : wp_login_url( gmr_theme_page_url( 'coleccionistas' ) ) ); ?>">Coleccionistas</a>
