...
<a class="gmr-account" href="<?php echo esc_url( gmr_theme_page_url( 'coleccionistas' ) ); ?>"><span><?php echo esc_html(is_user_logged_in()?'Mi colección':gmr_theme_mod('gmr_collector_label')); ?></span><i aria-hidden="true">↗</i></a>
